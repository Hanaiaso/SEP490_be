...
namespace VietTien.API.Migrations
{
    ...
    [Migration("20260825093152_AddQuarantineLogParentId")]
    partial class AddQuarantineLogParentId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VietTien.API.Models.CartItem", b =>
                {
                    ...
                    b.Property<DateTime?>("ReservationReleasedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("VietTien.API.Models.DeliveryAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("OrderId", "DeliveryTripId");
            ...
            modelBuilder.Entity("VietTien.API.Models.DeliveryTrip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("VehicleId", "Shift", "TripDate");
            ...
            modelBuilder.Entity("VietTien.API.Models.Inventory", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSlowMovingAlertSentAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("VietTien.API.Models.MarketingPost", b =>
                {
                    ...
                    b.Property<DateTime?>("LastMetricsSyncedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("VietTien.API.Models.Material", b =>
                {
                    ...
                    b.Property<double?>("MaxStockThreshold")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("VietTien.API.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("PackedBoxCount")
                        .HasColumnType("int");

                    b.Property<DateTime?>("PackingCompletedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("PackingEvidenceUrls")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RedInvoiceDocumentUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("RedInvoiceEnteredByUserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("RedInvoiceIssuedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("RedInvoiceNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal?>("TotalPackedWeightKg")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("VietTien.API.Models.Product", b =>
                {
                    ...
                    b.Property<int?>("ExcessThreshold")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VietTien.API.Models.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("VietTien.API.Models.ProductPriceUpdateOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<DateTime>("ScheduledEffectiveDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("ProductPriceUpdateOrders");
                });

            modelBuilder.Entity("VietTien.API.Models.ProductPriceUpdateOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("ProductPriceUpdateOrderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductPriceUpdateOrderId");

                    b.ToTable("ProductPriceUpdateOrderItems");
                });
            ...
            modelBuilder.Entity("VietTien.API.Models.QuarantineLog", b =>
                {
                    ...
                    b.Property<Guid?>("ParentQuarantineLogId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ParentQuarantineLogId");
            ...
            modelBuilder.Entity("VietTien.API.Models.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Key = "INVENTORY_COUNT_VARIANCE_THRESHOLD",
                            Description = "Chênh lệch tối đa (số lượng tuyệt đối) khi đóng phiên kiểm kê được áp dụng thẳng; vượt ngưỡng bắt buộc CEO duyệt",
                            IsActive = true,
                            IsSecret = false,
                            OwnerLevel = "Admin/CEO",
                            Unit = "Đơn vị",
                        ...
                        new
                        {
                            Key = "SLOW_MOVING_DAYS_THRESHOLD",
                            Description = "Số ngày không phát sinh xuất kho để tính là hàng chậm luân chuyển / tồn đọng (dùng chung cho cảnh báo chủ động và KPI Dashboard Kho)",
                            IsActive = true,
                            IsSecret = false,
                            OwnerLevel = "Admin/CEO",
                            Unit = "Ngày",
            ...
            modelBuilder.Entity("VietTien.API.Models.SystemConfigVersion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a0000001-0001-4001-a001-000000000013"),
                            ActorEmail = "system-seed",
                            ChangeReason = "Khởi tạo giá trị mặc định theo business.md §7",
                            ConfigKey = "INVENTORY_COUNT_VARIANCE_THRESHOLD",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            EffectiveDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Value = "5"
                        },
                        new
                        {
                            Id = new Guid("a0000001-0001-4001-a001-000000000014"),
                            ActorEmail = "system-seed",
                            ChangeReason = "Khởi tạo giá trị mặc định theo business.md §7",
                            ConfigKey = "SLOW_MOVING_DAYS_THRESHOLD",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            EffectiveDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Value = "30"
                        });
            ...
            modelBuilder.Entity("VietTien.API.Models.DeliveryAttempt", b =>
                {
                    b.HasOne("VietTien.API.Models.DeliveryTrip", "DeliveryTrip")
                        .WithMany("Attempts")
                    ...
                    b.HasOne("VietTien.API.Models.User", "RecordedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("VietTien.API.Models.DeliveryTrip", b =>
                {
                    ...
                    b.HasOne("VietTien.API.Models.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("VietTien.API.Models.InventoryCountSession", b =>
                {
                    b.HasOne("VietTien.API.Models.User", "ClosedByUser")
                        .WithMany()
                        .HasForeignKey("ClosedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("VietTien.API.Models.User", "OpenedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("VietTien.API.Models.InventoryCountSessionItem", b =>
                {
                    ...
                    b.HasOne("VietTien.API.Models.InventoryCountSession", "Session")
                        .WithMany("Items")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VietTien.API.Models.StockAdjustment", "StockAdjustment")
                        .WithMany()
            ...
            modelBuilder.Entity("VietTien.API.Models.ProductPriceUpdateOrder", b =>
                {
                    b.HasOne("VietTien.API.Models.User", "AssignedByManager")
                        .WithMany()
                    ...
                    b.HasOne("VietTien.API.Models.User", "ExecutedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("VietTien.API.Models.ProductPriceUpdateOrderItem", b =>
                {
                    ...
                    b.HasOne("VietTien.API.Models.ProductPriceUpdateOrder", "ProductPriceUpdateOrder")
                        .WithMany("Items")
                        .HasForeignKey("ProductPriceUpdateOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Product");

                    b.Navigation("ProductPriceUpdateOrder");
                });
            ...
            modelBuilder.Entity("VietTien.API.Models.QuarantineLog", b =>
                {
                    ...
                    b.HasOne("VietTien.API.Models.QuarantineLog", "ParentQuarantineLog")
                        .WithMany()
                        .HasForeignKey("ParentQuarantineLogId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("ParentQuarantineLog");
